            ...
            <div className="bg-gray-800 flex flex-col justify-center">
                <form className='max-w-[400px] w-full mx-auto bg-gray-900 p-8 px-8 rounded-lg'>
                    ...
                    <div className="flex justify-between text-gray-400 py-2">
                        <p className="flex items-center"><input className="mr-2"type="checkbox">Remember Me</input></p>
                        <p>Forgot Password</p>
                    </div>
                    <button classNamw='w-full my-5 py-2 bg-teal-500 shadow-lg shadow-teal-500/50 hover:shadow-teal-500/40 text-white font-semibold rounded-lg'>Sign In</button>
                </form>
